...
<div class="modal fade" id="editAANRPageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo e(Form::open(['action' => ['AANRPageController@editAANRPage', $aanrPage->id], 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('full_name', $aanrPage->full_name, ['class' => 'form-control', 'placeholder' => 'Add full name'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('short_name', 'Consortia Short Name', ['class' => 'col-form-label required'])); ?>

                    <?php echo e(Form::text('short_name', $aanrPage->short_name, ['class' => 'form-control', 'placeholder' => 'Add acronym/short name'])); ?>
                ...
                <div class="form-group">
                    <div class="mt-3">
                        ...
                        <img src="/storage/page_images/<?php echo e($aanrPage->thumbnail); ?>" class="card-img-top" style="object-fit: cover;overflow:hidden;height:250px;width:250px;border:1px solid rgba(100,100,100,0.25)" >
                        <?php else: ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('profile', $aanrPage->profile, ['class' => 'form-control', 'placeholder' => 'Add a profile', 'rows' => '4'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('contact_name', 'Contact Name', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::text('contact_name', $aanrPage->contact_name, ['class' => 'form-control', 'placeholder' => 'Add contact name'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('contact_details', 'Contact Details', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::text('contact_details', $aanrPage->contact_details, ['class' => 'form-control', 'placeholder' => 'Add contact details'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('link', 'Link to website', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::text('link', $aanrPage->link, ['class' => 'form-control', 'placeholder' => 'Add a link'])); ?>
...
</div><?php /**PATH /var/www/aanrphp/resources/views/dashboard/modals/aanrpage.blade.php ENDPATH**/ ?>