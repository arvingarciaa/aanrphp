                        ...
                        <!-- Header Links Modals -->
                            <!-- Modal for ADD Header link -->
                                <div class="modal fade" id="addHeaderLinkModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-l" role="document">
                                        <div class="modal-content">
                                            <?php echo e(Form::open(['action' => ['HeaderLinksController@addHeaderLink'], 'method' => 'POST'])); ?>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <?php echo e(Form::label('link', 'Link to header', ['class' => 'col-form-label'])); ?>

                                                    <?php echo e(Form::text('link', '', ['class' => 'form-control', 'placeholder' => 'Add a link'])); ?>

                                                </div>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('weight', 'Position weight (lowest to highest, from left to right)', ['class' => 'col-form-label'])); ?>

                                                    <?php echo e(Form::text('weight', '', ['class' => 'form-control', 'placeholder' => 'Add a number'])); ?>
                            ...
                            <?php $__currentLoopData = $header_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!-- Modal for EDIT header link -->
                                <div class="modal fade" id="editHeaderLinkModal-<?php echo e($header->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-l" role="document">
                                        <div class="modal-content">
                                            <?php echo e(Form::open(['action' => ['HeaderLinksController@editHeaderLink', $header->id], 'method' => 'POST'])); ?>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('name', $header->name, ['class' => 'form-control', 'placeholder' => 'Add a name'])); ?>

                                                </div>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('link', 'Link to header', ['class' => 'col-form-label'])); ?>

                                                    <?php echo e(Form::text('link', $header->link, ['class' => 'form-control', 'placeholder' => 'Add a link'])); ?>

                                                </div>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('weight', 'Position weight (lowest to highest, from left to right)', ['class' => 'col-form-label'])); ?>

                                                    <?php echo e(Form::text('weight', $header->position, ['class' => 'form-control', 'placeholder' => 'Add a number'])); ?>
                                ...
                                <div class="modal fade" id="deleteHeaderLinkModal-<?php echo e($header->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <form action="<?php echo e(route('deleteHeaderLink', $header->id)); ?>" id="deleteForm" method="POST">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="exampleModalLabel">Confirm Delete</h6>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <span>
                                                    Are you sure you want to delete: <b><?php echo e($header->name); ?></b>?</br></br>
                                                </span>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-success" data-dismiss="modal">Cancel</button>
                        ...
                        <!-- Slider modals-->
                            <!-- Modal for add Slider -->
                                <div class="modal fade" id="addSliderModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-l" role="document">
                                        <div class="modal-content">
                                            <?php echo e(Form::open(['action' => ['LandingPageSlidersController@addSlider'], 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('is_video_create', 'Slider Type')); ?>

                                                    <?php echo e(Form::select('is_video_create', ['0' => 'Text/Image', 
                                                                                '1' => 'Video', 
                                                                                ], '',['class' => 'form-control', 'name' => 'is_video_create'])); ?>

                                                </div>
                                                <div class="form-group">
                                                    <?php echo e(Form::label('consortia', 'Consortia', ['class' => 'col-form-label'])); ?>
                                                    ...
                                                    <select name="consortia" class="form-control" id="consortia">
                                                        ...
                                                        <?php $__currentLoopData = App\Consortia::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consortium_add): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($consortium_add->id); ?>"><?php echo e($consortium_add->short_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select> 
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="is-video-create-no">
                                                    ...
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('textcard_enable', 'Enable text card?')); ?>

                                                        <?php echo e(Form::select('textcard_enable', ['yes' => 'Yes', 
                                                                                    'no' => 'No', 
                                                                                    ], '',['class' => 'form-control',])); ?>

                                                    </div>
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('button_text', 'Button Text', ['class' => 'col-form-label'])); ?>

                                                        <a href="#" data-toggle="tooltip" data-placement="top" title="Text for the button"><i class="far fa-question-circle"></i></a>
                                                        <?php echo e(Form::text('button_text', '', ['class' => 'form-control', 'placeholder' => 'Add a text for the button'])); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('link', '', ['class' => 'form-control', 'placeholder' => 'Add a link for the button'])); ?>

                                                    </div>
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('caption_align', 'Caption Align')); ?>
                                                        ...
                                                        <?php echo e(Form::select('caption_align', ['left' => 'Left', 
                                                                                    'center' => 'Center', 
                                                                                    'right' => 'Right'
                                                    ...
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('image', 'Slider Image', ['class' => 'col-form-label'])); ?>
                                                ...
                                                <div class="is-video-create-yes" style="display:none">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('video_link', 'Link to YouTube video', ['class' => 'col-form-label'])); ?>

                                                        <?php echo e(Form::text('video_link', '', ['class' => 'form-control', 'placeholder' => 'Add a YouTube link for the slider'])); ?>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                <?php echo e(Form::submit('Add Slider', ['class' => 'btn btn-success'])); ?>
                            ...
                            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!-- Modal for EDIT Slider -->
                                    <div class="modal fade" id="editSliderModal-<?php echo e($slider->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-l" role="document">
                                            <div class="modal-content">
                                                <?php echo e(Form::open(['action' => ['LandingPageSlidersController@editSlider', $slider->id], 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('is_video_edit', 'Slider Type')); ?>

                                                        <?php echo e(Form::select('is_video_edit', ['0' => 'Text/Image', 
                                                                                    '1' => 'Video', 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="consortia" class="form-control" id="consortia">
                                                            <option value="" disabled> Select Consortia </option>
                                                            <option value="0" <?php echo e($slider->consortia_id == null || $slider->consortia_id == 0 ? 'selected' : ''); ?>>AANR</option>
                                                            <?php $__currentLoopData = App\Consortia::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consortium_edit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($consortium_edit->id); ?>" <?php echo e($slider->consortia_id == $consortium_edit->id ? 'selected' : ''); ?>><?php echo e($consortium_edit->short_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select> 
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('title', $slider->title, ['class' => 'form-control', 'placeholder' => 'Add a title'])); ?>

                                                    </div>
                                                    <div class="is-video-edit-no" style="<?php echo e($slider->is_video == 1 ? 'display:none' : ''); ?>">
                                                        <div class="form-group">
                                                            <?php echo e(Form::label('textcard_enable', 'Enable text card?')); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo e(Form::textarea('description', $slider->description, ['class' => 'form-control', 'placeholder' => 'Add a description', 'rows' => 4])); ?>

                                                        </div>
                                                        <div class="form-group">
                                                            <?php echo e(Form::label('button_text', 'Button Text', ['class' => 'col-form-label'])); ?>

                                                            <?php echo e(Form::text('button_text', $slider->button_text, ['class' => 'form-control', 'placeholder' => 'Add a text for the button'])); ?>

                                                        </div>
                                                        <div class="form-group">
                                                            <?php echo e(Form::label('link', 'Link to article', ['class' => 'col-form-label'])); ?>

                                                            <?php echo e(Form::text('link', $slider->link, ['class' => 'form-control', 'placeholder' => 'Add a link'])); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <?php echo e(Form::label('image', 'Replace Image', ['class' => 'col-form-label'])); ?>

                                                            <img src="/storage/cover_images/<?php echo e($slider->image); ?>" class="card-img-top" style="width:100%;border:1px solid rgba(100,100,100,0.25)" >
                                                            <?php echo e(Form::file('image', ['class' => 'form-control mt-2 mb-3 pt-1'])); ?>

                                                        </div>
                                                    </div>
                                                    <div class="is-video-edit-yes" style="<?php echo e($slider->is_video == 0 ? 'display:none' : ''); ?>">
                                                        <div class="form-group">
                                                            <?php echo e(Form::label('video_link', 'Link to YouTube video', ['class' => 'col-form-label'])); ?>

                                                            <?php echo e(Form::text('video_link', $slider->video_link, ['class' => 'form-control', 'placeholder' => 'Add a YouTube link for the slider'])); ?>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                    <?php echo e(Form::submit('Submit Changes', ['class' => 'btn btn-success'])); ?>
                                ...
                                <!-- Modal for delete Slider -->
                                    <div class="modal fade" id="deleteSliderModal-<?php echo e($slider->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form action="<?php echo e(route('deleteSlider', $slider->id)); ?>" id="deleteForm" method="POST">
                                                <div class="modal-header">
                                                    <h6 class="modal-title" id="exampleModalLabel">Confirm Delete</h6>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span>
                                                        Are you sure you want to delete: <b><?php echo e($slider->title); ?></b>
                                                    </span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-success" data-dismiss="modal">Cancel</button>
