    ...
    <div class="modal fade" id="createArtifactModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <?php echo e(Form::open(['action' => ['ArtifactAANRController@addArtifact'], 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                    ...
                    <div class="tab-content mb-3" id="addArtifactTabContent">
                        <div class="tab-pane fade show active" id="file-upload" role="tabpanel" aria-labelledby="file-upload">
                            <div class="form-group">
                                <?php echo e(Form::label('consortia', 'Consortia', ['class' => 'col-form-label required'])); ?>
                                ...
                                <select name="consortia" class="form-control dynamic_consortia_member" id="consortia" data-dependent="Consortia Member">
                                    ...
                                    <?php $__currentLoopData = App\Consortia::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consortium): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($consortium->id); ?>"><?php echo e($consortium->short_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select> 
                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('consortia_member', 'SUC/Unit/Institution', ['class' => 'col-form-label'])); ?>
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('title', 'Content Title', ['class' => 'col-form-label required'])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('content', $content, '',['class' => 'dynamic_content_subtype form-control', 'placeholder' => 'Select Content Type', 'data-dependent' => "Content Subtype"])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('subcontent_type', 'Subcontent Type', ['class' => 'col-form-label'])); ?>
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('isp', 'ISPs', ['class' => 'col-form-label'])); ?> 
                                <br>
                                <?php echo e(Form::select('isp[]', $isp, null, ['class' => 'form-control multi-isp-create w-100', 'multiple' => 'multiple'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('commodity', 'Commodities', ['class' => 'col-form-label'])); ?> 
                                <br>
                                <?php echo e(Form::select('commodities[]', $commodities, null, ['class' => 'form-control multi-commodity-create w-100', 'multiple' => 'multiple'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('date_published', 'Date Published', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::date('date_published','',['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('author', 'Author', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::text('author', '', ['class' => 'form-control', 'placeholder' => 'e.g. Mae Santos'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('author_affiliation', 'Author Affilitation', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::text('author_affiliation', '', ['class' => 'form-control', 'placeholder' => 'e.g. DOST-PCAARRD S&T Media Service'])); ?>
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('manual_file', 'File Upload (PDF, JPEG, PNG)', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::file('manual_file', ['class' => 'form-control mb-3 pt-1'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('link', 'Redirect Link', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::text('link', '', ['class' => 'form-control', 'placeholder' => 'Add a link'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('embed_link', 'Embed Link', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::text('embed_link', '', ['class' => 'form-control', 'placeholder' => 'Add a link to embed to the content modal'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('keywords', 'Search keywords', ['class' => 'col-form-label'])); ?>

                                <?php echo e(Form::text('keywords', '', ['class' => 'form-control', 'placeholder' => 'Separate keywords with commas (,)'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('is_gad', 'GAD Focus?', ['class' => 'col-form-label mb-1'])); ?>
                        ...
                        <div class="tab-pane fade" id="csv-upload" role="tabpanel" aria-labelledby="csv-upload">
                            <div class="form-group">
                                <?php echo e(Form::label('csv_file', 'Upload CSV File', ['class' => 'col-form-label required'])); ?>

                                <?php echo e(Form::file('csv_file', ['class' => 'form-control mb-3 pt-1'])); ?>
                ...
                <div class="modal-footer">
                    ...
                    <?php echo e(Form::submit('Create Artifact', ['class' => 'btn btn-success'])); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('title', '', ['class' => 'form-control', 'placeholder' => 'Add a title', 'id' => 'edit-title', 'value' => ''])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('content', 'Content Type', ['class' => 'col-form-label required'])); ?>

                    <?php echo e(Form::select('content', $content, '',['class' => 'dynamic_content_subtype form-control', 'id' => 'edit-content', 'placeholder' => 'Select Content Type', 'data-dependent' => "Content Subtype"])); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('commodity', 'Commodities', ['class' => 'col-form-label'])); ?> 
                    <br>
                    <?php echo e(Form::select('commodities[]', $commodities, null, ['id' => 'edit-commodity', 'class' => 'form-control multi-commodity-edit w-100', 'multiple' => 'multiple'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('date_published', 'Date Published', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::date('date_published','',['id' => 'edit-date-published', 'class' => 'form-control'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('author', 'Author', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::text('author', '', ['id' => 'edit-author', 'class' => 'form-control', 'placeholder' => 'e.g. Mae Santos'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('author_affiliation', 'Author Affilitation', ['class' => 'col-form-label'])); ?>

                    <?php echo e(Form::text('author_affiliation', '', ['id' => 'edit-author-affiliation', 'class' => 'form-control', 'placeholder' => 'e.g. DOST-PCAARRD S&T Media Service'])); ?>

                </div>
                <div class="form-group">
                            <?php echo e(Form::label('description', 'Description', ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::textarea('description', '', ['id' => 'edit-description', 'class' => 'form-control', 'placeholder' => 'Add a description', 'rows' => 4])); ?>

                </div>
                <div class="form-group">
                            <?php echo e(Form::label('file', 'File Upload (PDF, JPEG, PNG)', ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::file('file', ['class' => 'form-control mb-3 pt-1'])); ?>

                </div>
                <div class="form-group">
                            <?php echo e(Form::label('link', 'Link', ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::text('link', '', ['id' => 'edit-link', 'class' => 'form-control', 'placeholder' => 'Add a link'])); ?>

                </div>
                <div class="form-group">
                            <?php echo e(Form::label('keywords', 'Search keywords', ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::text('keywords', '', ['id' => 'edit-keywords', 'class' => 'form-control', 'placeholder' => 'Separate keywords with commas (,)'])); ?>
            ...
            <div class="modal-footer">
                ...
                <?php echo e(Form::submit('Update AANR Content', ['class' => 'btn btn-success'])); ?>
...
<script>
    ...
    $('.dynamic_consortia_member').change(function(){
        if($(this).val() != ''){
            ...
            $.ajax({
                url:"<?php echo e(route('fetchConsortiaMemberDependent')); ?>",
                method:"POST",
    ...
    $('.dynamic_content_subtype').change(function(){
        if($(this).val() != ''){
            ...
            var _token = $('input[name="_token"]').val();
            $.ajax({
                url:"<?php echo e(route('fetchContentSubtypeDependent')); ?>",
                method:"POST",
    ...
    $('.dynamic_commodity').change(function(){
        if($(this).val() != ''){
            ...
            var _token = $('input[name="_token"]').val();
            $.ajax({
                url:"<?php echo e(route('fetchCommodityDependent')); ?>",
                method:"POST",
...
</style><?php /**PATH /var/www/aanrphp/resources/views/dashboard/modals/artifact.blade.php ENDPATH**/ ?>