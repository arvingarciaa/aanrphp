...
<div class="modal fade" id="editIndustryProfileSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editIndustryProfileSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    {{Form::label('industry_profile_subheader', 'Industry Profile Subheader', ['class' => 'col-form-label required'])}}
                    {{Form::text('industry_profile_subheader', $landing_page->industry_profile_subheader, ['class' => 'form-control'])}}
                </div>
                ...
                <div class="form-group">
                    {{Form::label('image', 'Agriculture Background', ['class' => 'col-form-label required'])}}
                    <br>
                    @if($landing_page->industry_profile_agri_bg!=null)
                    <img src="/storage/page_images/{{$landing_page->industry_profile_agri_bg}}" class="card-img-top" style="object-fit: cover;overflow:hidden;width:200px;border:1px solid rgba(100,100,100,0.25)" >
                    @else
                    <div class="card-img-top center-vertically px-3" style="height:200px; width:200px; background-color: rgb(227, 227, 227);">
                        <span class="font-weight-bold" style="font-size: 17px;line-height: 1.5em;color: #2b2b2b;">
                    ...
                    @endif 
                    {{ Form::file('agri_bg', ['class' => 'form-control mt-2 mb-3 pt-1'])}}
                </div>
                <div class="dropdown-divider mt-3"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    {{Form::label('image', 'Aquatic Background', ['class' => 'col-form-label required'])}}
                    <br>
                    @if($landing_page->industry_profile_agri_bg!=null)
                    <img src="/storage/page_images/{{$landing_page->industry_profile_aqua_bg}}" class="card-img-top" style="object-fit: cover;overflow:hidden;width:200px;border:1px solid rgba(100,100,100,0.25)" >
                    @else
                    <div class="card-img-top center-vertically px-3" style="height:200px; width:200px; background-color: rgb(227, 227, 227);">
                        <span class="font-weight-bold" style="font-size: 17px;line-height: 1.5em;color: #2b2b2b;">
                            Upload a 250x250px logo for the background.
                    ...
                    @endif 
                    {{ Form::file('aqua_bg', ['class' => 'form-control mt-2 mb-3 pt-1'])}}
                </div>
                <div class="dropdown-divider mt-3"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    {{Form::label('image', 'Natural Resources Background', ['class' => 'col-form-label required'])}}
                    <br>
                    @if($landing_page->industry_profile_natural_bg!=null)
                    <img src="/storage/page_images/{{$landing_page->industry_profile_natural_bg}}" class="card-img-top" style="object-fit: cover;overflow:hidden;width:200px;border:1px solid rgba(100,100,100,0.25)" >
                    @else
                    <div class="card-img-top center-vertically px-3" style="height:200px; width:200px; background-color: rgb(227, 227, 227);">
                        <span class="font-weight-bold" style="font-size: 17px;line-height: 1.5em;color: #2b2b2b;">
                            Upload a 250x250px logo for the background.
...
<div class="modal fade" id="editLatestAANRSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editLatestAANRSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {{Form::text('latest_aanr_subheader', $landing_page->latest_aanr_subheader, ['class' => 'form-control'])}}
                </div>
                {{Form::label('banner', 'Change banner', ['class' => 'col-form-label'])}}
                <div class="input-group">
                    <label class="mr-2 radio-inline"><input type="radio" name="banner_color_radio_latest_aanr" value="1" {{$landing_page->latest_aanr_bg_type == 1 ? 'checked': ''}}> Block color</label>
                    <label class="mx-2 radio-inline"><input type="radio" name="banner_color_radio_latest_aanr" value="0" {{$landing_page->latest_aanr_bg_type != 1 ? 'checked': ''}}> Image</label>
                </div>
                <div class="form-group block-color-form_latest_aanr" style="{{$landing_page->latest_aanr_bg_type == 0 ? 'display:none': ''}}">
                    {{Form::label('banner_color', 'Change block color', ['class' => 'col-form-label'])}}
                    {{Form::text('banner_color', $landing_page->latest_aanr_bg == 1 ? $landing_page->latest_aanr_bg : null, ['class' => 'form-control', 'placeholder' => 'Add a hex'])}}
                </div>
                <div class="form-group gradient-color-form_latest_aanr" style="{{$landing_page->latest_aanr_bg_type != 0 ? 'display:none': ''}}">
                    {{Form::label('image', 'Latest AANR Section Background', ['class' => 'col-form-label required'])}}
                    <br>
                    @if($landing_page->latest_aanr_bg!=null && $landing_page->latest_aanr_bg_type == 0)
                    <img src="/storage/page_images/{{$landing_page->latest_aanr_bg}}" class="card-img-top" style="object-fit: cover;overflow:hidden;width:100%;border:1px solid rgba(100,100,100,0.25)" >
                    @else
...
<div class="modal fade" id="editUserTypeRecommendationSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editUserTypeRecommendationSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    {{Form::label('user_type_recommendation_subheader', 'User Type Recommendation Subheader', ['class' => 'col-form-label required'])}}
                    {{Form::text('user_type_recommendation_subheader', $landing_page->user_type_recommendation_subheader, ['class' => 'form-control'])}}
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="editFeaturedPublicationsSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editFeaturedPublicationsSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
...
<div class="modal fade" id="editFeaturedVideosSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editFeaturedVideosSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {{Form::text('featured_videos_subheader', $landing_page->featured_videos_subheader, ['class' => 'form-control'])}}
                </div>  
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('first_link', $landing_page->featured_video_link_1, ['class' => 'form-control required', 'placeholder' => 'Copy link from YouTube'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('second_link', 'Featured Video #2', ['class' => 'col-form-label'])}}
                        {{Form::text('second_link', $landing_page->featured_video_link_2, ['class' => 'form-control', 'placeholder' => 'Copy link from YouTube'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('thirt_link', 'Featured Video #3', ['class' => 'col-form-label'])}}
                        {{Form::text('thirt_link', $landing_page->featured_video_link_3, ['class' => 'form-control', 'placeholder' => 'Copy link from YouTube'])}}
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="editRecommendedForYouSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editRecommendedForYouSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    {{Form::label('recommended_for_you_subheader', 'Recommended For You Subheader', ['class' => 'col-form-label required'])}}
                    {{Form::text('recommended_for_you_subheader', $landing_page->recommended_for_you_subheader, ['class' => 'form-control'])}}
                </div>
                {{Form::label('banner', 'Change banner', ['class' => 'col-form-label'])}}
                <div class="input-group">
                    <label class="mr-2 radio-inline"><input type="radio" name="banner_color_radio" value="1" {{$landing_page->recommended_for_you_bg_type == 1 ? 'checked': ''}}> Block color</label>
                    <label class="mx-2 radio-inline"><input type="radio" name="banner_color_radio" value="0" {{$landing_page->recommended_for_you_bg_type != 1 ? 'checked': ''}}> Image</label>
                </div>
                <div class="form-group block-color-form" style="{{$landing_page->recommended_for_you_bg_type == 0 ? 'display:none': ''}}">
                    {{Form::label('banner_color', 'Change block color', ['class' => 'col-form-label'])}}
                    {{Form::text('banner_color', $landing_page->recommended_for_you_bg_type == 1 ? $landing_page->recommended_for_you_bg : null, ['class' => 'form-control', 'placeholder' => 'Add a hex'])}}
                </div>
                <div class="form-group gradient-color-form" style="{{$landing_page->recommended_for_you_bg_type != 0 ? 'display:none': ''}}">
                    {{Form::label('image', 'Recommended for You Section Background', ['class' => 'col-form-label required'])}}
                    <br>
                    @if($landing_page->recommended_for_you_bg!=null && $landing_page->recommended_for_you_bg_type == 0)
                    <img src="/storage/page_images/{{$landing_page->recommended_for_you_bg}}" class="card-img-top" style="object-fit: cover;overflow:hidden;width:100%;border:1px solid rgba(100,100,100,0.25)" >
                    @else
                    <div class="card-img-top center-vertically px-3" style="height:225px; width:100%; background-color: rgb(227, 227, 227);">
                        <span class="font-weight-bold" style="font-size: 17px;line-height: 1.5em;color: #2b2b2b;">
                            Upload a 1800x550px logo for the background.
...
<div class="modal fade" id="editConsortiaMembersSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['LandingPageElementsController@editConsortiaMembersSection'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            <div class="modal-header">
