...
<div class="modal fade" id="editPCAARRDPageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{ Form::open(['action' => ['PCAARRDPageController@editPCAARRDPage', $pcaarrdPage->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {{Form::text('full_name', $pcaarrdPage->full_name, ['class' => 'form-control', 'placeholder' => 'Add full name'])}}
                </div>
                <div class="form-group">
                    {{Form::label('short_name', 'Consortia Short Name', ['class' => 'col-form-label required'])}}
                    {{Form::text('short_name', $pcaarrdPage->short_name, ['class' => 'form-control', 'placeholder' => 'Add acronym/short name'])}}
                </div>
                <div class="form-group">
                    <div class="mt-3">
